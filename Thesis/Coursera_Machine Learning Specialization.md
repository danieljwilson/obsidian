...
- Deep Q network (deep QN)
![[Pasted image 20230404101855.png]]
![[Pasted image 20230404101955.png]]
#### $\epsilon$-greedy policy
- pick the non-optimal policy occasionally (based on $\epsilon$ value)
- can start with a high value and then slowly decrease it (as you learn more)

#### [[mini-batch learning]]
![[Pasted image 20230404103041.png]]
#### [[Soft update]]
- make more gradual change to neural network parameters
![[Pasted image 20230404103321.png]]
