...
Start at a given state and then explore options...
[[frontier]] represents all of the states that we **could** explore **next**...
- empty frontier means there is nowhere to go...you are stuck...nothing left to explore...no solution 
- process of search involves removing a node from the frontier...test whether it contains the solution?
- if it does not contain the solution then you "expand the node"...add resulting nodes to the frontier (i.e. what are possible states we can get to next?)
...
**Example**
![[Pasted image 20231025100536.png]]
In this case following the rules leads to a suboptimal path...
Optimal path would have been this 👇
![[Pasted image 20231025100615.png]]
